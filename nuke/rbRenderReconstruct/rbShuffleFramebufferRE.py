...
#RbShuffleFramebufferRE class
#------------------------------------------------------------------

class RbShuffleFramebufferRE():
	...
	def reconstructFramebufferRenderElements(self, node):
		...
		#rbReflection
		if(self.getLayers(node, 'rbReflection')): outputDotList.append(self.shuffleRE(node, 'rbReflection', frameBuffer = True))
			
		#rbRefraction
		if(self.getLayers(node, 'rbRefraction')): outputDotList.append(self.shuffleRE(node, 'rbRefraction', frameBuffer = True))
			
		#rbSpecular
		if(self.getLayers(node, 'rbSpecular')): outputDotList.append(self.shuffleRE(node, 'rbSpecular', frameBuffer = True))
		
		#rbSubsurface
		if(self.getLayers(node, 'rbSubsurface')): outputDotList.append(self.shuffleRE(node, 'rbSubsurface', frameBuffer = True))
