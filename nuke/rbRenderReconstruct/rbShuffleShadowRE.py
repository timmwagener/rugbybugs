...
#RbShuffleShadowRE class
#------------------------------------------------------------------

class RbShuffleShadowRE():
	...
	def reconstructShadowRenderElements(self, node):
		...
		if(self.getLayers(node, 'rbRawShadow')): shadowShuffleNodesList.append(self.shuffleRE(node, 'rbRawShadow'))
		
		#check if rbShadow channel exists and if so, shuffle it
		if(self.getLayers(node, 'rbShadow')): shadowShuffleNodesList.append(self.shuffleRE(node, 'rbShadow'))
