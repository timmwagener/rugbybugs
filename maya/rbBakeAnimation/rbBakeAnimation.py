...
#RbBakeAnimation class
#------------------------------------------------------------------

class RbBakeAnimation():
...
#Create Instance
rbBakeAnimationInstance = rbBakeAnimation.RbBakeAnimation()

#Execute
rbBakeAnimationInstance.bakeAnimation(animationStartTime = 0, animationEndTime = 40)
